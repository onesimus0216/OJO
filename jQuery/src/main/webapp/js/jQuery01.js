...
//	1.
//	onload = function () {
//		alert('javascript onload 이벤트 1');
//	}
//	2.
//	onload = () => {
//		alert('javascript onload 이벤트 2');
//	}

//	jQuery onload
//	1.
//	$(document).ready(function () {
//		alert('jQuery onload 이벤트 1');
//	});
//	2.
//	$().ready(function () { // document 생략
//		alert('jQuery onload 이벤트 2');
//	});
//	3.
//	$().ready(() => { // 화살표 함수
//		alert('jQuery onload 이벤트 3');
//	});
//	4.
//	$(function () { // ().ready 생략
//		alert('jQuery onload 이벤트 4');
//	});
//	5.
//	$(() => { // ().ready 생략, 화살표 함수
//		alert('jQuery onload 이벤트 5');
//	});
...
//	$('#list').css('background-color', 'chocolate'); // css 개별 속성 스타일
	$('#list').css('background', 'hotpink'); // css 단축 속성 스타일
