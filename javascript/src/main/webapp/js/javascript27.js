...
//	'==', '!='는 데이터 타입은 비교하지 않고 데이터만 비교한다. '1'와 1는 같은 값으로 취급한다.
//	'===', '!=='는 데이터 타입과 데이터를 모두 비교한다. '1'와 1는 다른 값으로 취급한다.
	let num = 10;
...
function strTest4() {
//	indexOf(): 문자열 왼(앞)쪽 부터 인수로 저정한 문자열을 찾아 index를 리턴한다.
//	lastIndexOf(): 문자열 오른(뒤)쪽 부터 인수로 저정한 문자열을 찾아 index를 리턴한다.
