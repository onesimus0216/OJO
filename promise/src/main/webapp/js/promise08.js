//	기존에 존재하는 것(Promise) 위에 또는 기존에 존재하는 것을 감싸서 좀 더 편하게 사용할 수 있게
...
function pickAllFruits() {
	// all() 함수의 인수로 Promise가 저장된 배열을 전달하면 배열로 전달한 모든 Promise가
...
function pickOnlyOne() {
	// race() 함수의 인수로 Promise가 저장된 배열을 전달하면 배열로 전달한 Promise 중에서
